...
export const REMEDIATION_CATALOG: readonly RemediationEntry[] = [
  ...
  },
  {
    ...
    desiredState: 'Optional agent-readable overview. No watched engine documents a ranking or citation benefit; this remains outside the score.',
    copyPaste: 'Optional experiment: publish an /llms.txt Markdown overview of the business and its most useful pages. No measurable visibility benefit is promised.',
