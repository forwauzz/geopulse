...
export default async function AiVisibilityAuditPage() {
  ...
  return <><script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(schema) }} /><SearchFoundationPage
    ...
    related={[{ href: '/blog/seo-ai-visibility-audit', label: 'AI visibility audit checklist', body: 'Use the practical 10-step checklist and reporting handoff.' }, { href: '/ai-search-optimization', label: 'AI search optimization', body: 'Learn the broader program an audit supports.' }, { href: '/methodology/ai-search-readiness-audit', label: 'Methodology', body: 'Understand what a readiness audit can and cannot establish.' }]}
